 ...
 */
public class NeuronIDRangePartitioner extends Partitioner<IntWritable, NeuronStateWritable> {
	...
	@Override
	public int getPartition(IntWritable key, NeuronStateWritable value, int numReduceTasks) {
		/*
